...
function InputGroup({
  ...
  return (
    <InputGroupContext value={formSize}>
...
const inputGroupButtonVariants = cva('flex items-center gap-2 shadow-none', {
  variants: {
    size: {
      ...
      xl: '',
      xxl: '',
      'icon-xxs': 'p-0 has-[>svg]:p-0',
      'icon-xs': 'p-0 has-[>svg]:p-0',
      'icon-sm': 'p-0 has-[>svg]:p-0',
      'icon-md': 'p-0 has-[>svg]:p-0',
      'icon-lg': 'p-0 has-[>svg]:p-0',
      'icon-xl': 'p-0 has-[>svg]:p-0',
      'icon-xxl': 'p-0 has-[>svg]:p-0',
    },
  },
  defaultVariants: {
    size: 'xs',
