...
const usageSamples = [
  {
    ...
    label: 'Default',
    preview: <Spinner />,
    code: `import { Spinner } from "@/design-system/components/ui/spinner";
...
export default function SpinnerGuidePage() {
  return (
        ...
        <div className="mt-8 space-y-6">
          <Card id="import" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Import the spinner component from the design system.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto rounded-2xl border border-border/70 bg-muted/30 p-4">
                <code className="text-sm">{`import { Spinner } from "${guide.importPath}"`}</code>
              </div>
            </CardContent>
          </Card>
          ...
          <Card id="props" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Spinner component props.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card id="usages" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Common spinner patterns and configurations.</CardDescription>
            </CardHeader>
            <CardContent>
