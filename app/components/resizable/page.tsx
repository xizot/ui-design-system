...
const guide = getGuide('resizable');
...
export function Example() {
  ...
  },
  {
    ...
    label: 'Vertical',
    preview: (
      <ResizablePanelGroup className="flex min-h-[200px] max-w-md flex-col rounded-lg border">
...
export default function ResizableGuidePage() {
  useEffect(() => {
