...
const guide = getGuide('direction');
...
function Example() {
  ...
  },
  {
    ...
    preview: (
      <div className="w-full max-w-sm p-4">
        <div className="border-border bg-card rounded-lg border p-4" dir="rtl">
          <p className="text-sm">Right-to-left text direction</p>
          <p className="text-muted-foreground mt-2 text-sm">
            This is used for languages like Arabic, Hebrew, etc.
          </p>
        </div>
      </div>
    ),
      ...
      <main className="min-w-0">
        <section className="border-border/70 bg-card rounded-[28px] border px-8 py-10 shadow-sm">
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl text-base leading-7">
            A direction component for controlling text direction (LTR/RTL) for internationalization
            support.
          </p>
        </section>
        ...
        <div className="mt-8 space-y-6">
          <Card id="import" className="border-border/70 rounded-[24px]">
            ...
            <CardContent>
              <CodeBlock
                code={`import { Direction } from "${guide.importPath}"`}
                id="import"
          ...
          <Card id="props" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>Direction component props.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card id="usages" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>Common Direction patterns and configurations.</CardDescription>
            </CardHeader>
            <CardContent>
