...
const guide = getGuide('breadcrumb');
...
export default function BreadcrumbGuidePage() {
  useEffect(() => {
      ...
      <main className="min-w-0">
        <section className="border-border/70 bg-card rounded-[28px] border px-8 py-10 shadow-sm">
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl text-base leading-7">
            Displays the hierarchy of a page, showing the current location in the site structure.
          </p>
        </section>
        ...
        <div className="mt-8 space-y-6">
          <Card id="import" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>
                Import the breadcrumb components from the design system.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CodeBlock
  ...
  BreadcrumbSeparator,
          ...
          <Card id="props" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>Breadcrumb component props.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card id="usages" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>Common breadcrumb patterns and configurations.</CardDescription>
            </CardHeader>
            <CardContent>
