...
const guide = getGuide('separator');
    ...
    preview: (
      <div className="space-y-4">
        <div className="space-y-1">
          <h4 className="text-sm leading-none font-medium">Separator</h4>
          <p className="text-muted-foreground text-sm">Separates content with a horizontal line.</p>
        </div>
        <Separator />
      ...
      <main className="min-w-0">
        ...
        <div className="mt-8 space-y-6">
          <Card id="import" className="border-border/70 rounded-[24px]">
            ...
            <CardContent>
              <CodeBlock
                code={`import { Separator } from "${guide.importPath}"`}
                id="import"
