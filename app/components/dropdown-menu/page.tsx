...
export default function DropdownMenuGuidePage() {
  return (
      ...
      <main className="min-w-0">
        <section className="rounded-[28px] border border-border/70 bg-card px-8 py-10 shadow-sm">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
            Displays a menu of actions or options in a dropdown overlay.
          </p>
        </section>
        ...
        <div className="mt-8 space-y-6">
          <Card id="import" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Import the dropdown menu components from the design system.
              </CardDescription>
            </CardHeader>
            <CardContent>
  ...
  DropdownMenuTrigger,
          ...
          <Card id="props" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>DropdownMenu component props.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card id="usages" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Common dropdown menu patterns and configurations.</CardDescription>
            </CardHeader>
            <CardContent>
