...
import { TypographyCode, TypographyH1, TypographyLead, TypographySmall } from '@/components/ui/typography';

export const metadata: Metadata = {
  title: 'Installation - UI Design System',
  description: 'Hướng dẫn cài đặt UI Design System',
};
        ...
        <div className="mt-8 space-y-6">
          <Card id="cli" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Chạy lệnh init để copy design system vào project của bạn.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="overflow-x-auto rounded-2xl border border-border/70 bg-card p-5 text-card-foreground">
                <pre className="text-sm leading-6">
                  <code>npx github:xizot/ui-design-system init</code>
                </pre>
              </div>
              <div className="overflow-x-auto rounded-2xl border border-border/70 bg-card p-5 text-card-foreground">
                <pre className="text-sm leading-6">
                  <code>npx github:xizot/ui-design-system</code>
                </pre>
              </div>
              <div className="overflow-x-auto rounded-2xl border border-border/70 bg-card p-5 text-card-foreground">
                <pre className="text-sm leading-6">
                  <code>npx github:xizot/ui-design-system help</code>
                </pre>
              </div>
            </CardContent>
          </Card>
          ...
          <Card id="structure" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>CLI cài design system vào một thư mục đích riêng để dễ quản lý.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto rounded-2xl border border-border/70 bg-card p-5 text-card-foreground">
                <pre className="text-sm leading-6">
  ...
  lib/`}</code>
          ...
          <Card id="behavior" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Flow cài đặt hiện tại tập trung vào copy file và cài dependency cần thiết.</CardDescription>
            </CardHeader>
          ...
          <Card id="usage" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Docs nên hướng dẫn consumer import từ thư mục đã được CLI copy vào.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto rounded-2xl border border-border/70 bg-card p-5 text-card-foreground">
                <pre className="text-sm leading-6">
                  <code>{`import { Button } from '@/design-system/components/ui/button';`}</code>
                </pre>
              </div>
            </CardContent>
          </Card>
