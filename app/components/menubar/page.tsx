  ...
  MenubarSubContent,
          ...
          <Card id="props" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>Menubar component props.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card id="usages" className="border-border/70 rounded-[24px]">
            <CardHeader>
              ...
              <CardDescription>Common menubar patterns and configurations.</CardDescription>
            </CardHeader>
            <CardContent>
