...
export default function NavigationMenuGuidePage() {
  return (
      ...
      <main className="min-w-0">
        <section className="rounded-[28px] border border-border/70 bg-card px-8 py-10 shadow-sm">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
            A collection of links for navigating websites, featuring a viewport that animates
            between items.
          </p>
        </section>
  ...
  NavigationMenuIndicator,
          ...
          <Card id="props" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>NavigationMenu component props.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card id="usages" className="rounded-[24px] border-border/70">
            <CardHeader>
              ...
              <CardDescription>Common navigation menu patterns.</CardDescription>
            </CardHeader>
            <CardContent>
